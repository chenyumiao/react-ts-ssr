...
const htmlPluginsAray = paths.htmlArray.map((v)=> {
    ...
    const fileArr = fileParse.dir.split('/');
    const moduleName = fileArr[fileArr.length-1];
    console.log(moduleName);
    entryObj[moduleName] = [
        require.resolve('./polyfills'),
        fileParse.dir+'/'+fileParse.name+'.tsx'
    ]
    ...
    return new HtmlWebpackPlugin({
        ...
        chunks: [moduleName],
        template: fileParse.dir+'/'+fileParse.base,
                ...
                loader:ExtractTextPlugin.extract(
                    Object.assign(
                    {
                      ...
                      use: [
                          ...
                          {
                              loader: require.resolve('sass-loader') // compiles scss to CSS
                          },
                      ],
                  },
                  extractTextPluginOptions
